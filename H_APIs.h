...
BOOL NtUserQuerySendMessage(OUT PMSG);//1
...
BOOL NtGdiGetBitmapDimension(HBITMAP,OUT PSIZE);//2
...
BOOL NtUserGetCursorInfo(PCURSORINFO);//1
...
BOOL NtGdiGetTextExtent(HDC,PWSTR,INT,OUT PSIZE,UINT);//5
...
BOOL NtGdiDoBanding(HDC,BOOL,OUT PPOINTL,OUT PSIZE);//4
...
BOOL NtGdiScaleViewportExtEx(HDC,INT,INT,INT,INT,OUT PSIZE);//6
...
BOOL NtGdiTransformPoints(HDC,PPOINT,PPOINT,INT,INT);//5
...
DWORD NtGdiGetGlyphIndicesW(HDC,PCWSTR,INT,DWORD,DWORD);//5
...
BOOL NtGdiGetTextExtentExW(HDC,PWSTR,ULONG,ULONG,OUT PULONG,PULONG,OUT PSIZE,FLONG);//8
...
ULONG_PTR NtGdiPolyPolyDraw(HDC,PPOINT,PULONG,ULONG,INT);//5
...
BOOL NtGdiScaleWindowExtEx(HDC,INT,INT,INT,INT,OUT PSIZE);//6
...
BOOL NtUserPeekMessage(PMSG,HWND,UINT,UINT,UINT);//5
...
BOOL NtUserGetMessage(PMSG,HWND,UINT,UINT);//4
...
DWORD NtGdiGetGlyphIndicesWInternal(HDC,PWSTR,INT,DWORD,DWORD,BOOL);//6
...
BOOL NtGdiSetBitmapDimension(HBITMAP,INT,INT,PSIZE);//4
...
LRESULT NtUserDispatchMessage(PMSG);//1
...
BOOL NtUserUpdateLayeredWindow(HWND,HDC,LPPOINT,PSIZE,HDC,LPPOINT,COLORREF,PBLENDFUNCTION,DWORD,LPRECT);//10
